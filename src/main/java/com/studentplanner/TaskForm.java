...
public class TaskForm extends VBox {
    ...
    public TaskForm() {
        ...
        dueDatePicker.setDayCellFactory(picker ->
                new DateCell() {
        ...
        priorityBox.setCellFactory(listView ->
                new ListCell<>() {
        ...
        GridPane mainFields = new GridPane();

        mainFields.setHgap(20);
        mainFields.setVgap(8);

        mainFields.add(taskLabel, 0, 0);
        mainFields.add(subjectLabel, 1, 0);

        mainFields.add(taskInput, 0, 1);
        mainFields.add(subjectInput, 1, 1);
        ...
        secondaryFields.setHgap(20);
        secondaryFields.setVgap(8);

        secondaryFields.add(dateLabel, 0, 0);
        secondaryFields.add(priorityLabel, 1, 0);

        secondaryFields.add(dueDatePicker, 0, 1);
        secondaryFields.add(priorityBox, 1, 1);
        ...
        saveButton = new Button("Add Task");
        ...
        // IMPORTANT:
        // Selecting priority does NOT save the task.
